...
// MemberAccessLog maps to the members_access_logs table.
type MemberAccessLog struct {
	...
	ExpiresAt    time.Time      `gorm:"not null;index:idx_members_access_logs_expires_at" json:"expires_at"`
	...
	Token        string         `gorm:"type:text;not null;index:idx_members_access_logs_token" json:"token"`
...
func (MemberAccessLog) TableName() string {
	return "members_access_logs"
}
